...
# ADDED Hardcode source path
HOST_SOURCE_PATH="../projects/groove-bela/"
...
uploadBuildRun(){
	...
	then
		...
		# ADDED
		rsync -ac --out-format="   %n" --no-t --delete-after --exclude=groove-bela --exclude=node_modules --exclude=build --exclude=install ../projects/groove-bela/ root@bela.local:/root/Bela/projects/groove-bela/
	fi
